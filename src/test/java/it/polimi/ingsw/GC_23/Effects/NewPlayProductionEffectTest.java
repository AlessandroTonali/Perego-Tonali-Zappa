 ...
 */
public class NewPlayProductionEffectTest {
    @Test
    public void activeEffect() throws Exception {
        ...
        NewPlayProductionEffect newPlayProductionEffect = new NewPlayProductionEffect(3);
        newPlayProductionEffect.activeEffect(player);
